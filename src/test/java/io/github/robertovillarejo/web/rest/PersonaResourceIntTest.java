...
public class PersonaResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllPersonasByNameIsEqualToSomething() throws Exception {
        // Initialize the database
        personaRepository.saveAndFlush(persona);

        // Get all the personaList where name equals to DEFAULT_NAME
        defaultPersonaShouldBeFound("name.equals=" + DEFAULT_NAME);

        // Get all the personaList where name equals to UPDATED_NAME
        defaultPersonaShouldNotBeFound("name.equals=" + UPDATED_NAME);
    }

    @Test
    @Transactional
    public void getAllPersonasByNameIsInShouldWork() throws Exception {
        // Initialize the database
        personaRepository.saveAndFlush(persona);

        // Get all the personaList where name in DEFAULT_NAME or UPDATED_NAME
        defaultPersonaShouldBeFound("name.in=" + DEFAULT_NAME + "," + UPDATED_NAME);

        // Get all the personaList where name equals to UPDATED_NAME
        defaultPersonaShouldNotBeFound("name.in=" + UPDATED_NAME);
    }

    @Test
    @Transactional
    public void getAllPersonasByNameIsNullOrNotNull() throws Exception {
        // Initialize the database
        personaRepository.saveAndFlush(persona);

        // Get all the personaList where name is not null
        defaultPersonaShouldBeFound("name.specified=true");

        // Get all the personaList where name is null
        defaultPersonaShouldNotBeFound("name.specified=false");
    }
